/*
 * mobile support unit tests - make this a module
 */
define([
    //"../../js/plugins/jquery/jquery-1.8.3.js",
    //"../../js/plugins/jquerymobile/jquery.mobile-1.4.0.js"
    'jquery',
		'jqm'
  ],
  function() {
    var testHelper = {
      ...
      asyncLoad: function( seq, baseUrl ) {console.log(baseUrl);
        require({
          baseUrl: baseUrl || "../../js"
        });
