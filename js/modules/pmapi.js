...
(function () {
  ...
  //ajax loader, process indicator
	//$("ol").html('<img src="ajax-loader.gif" border="0" class="ajax-progress"/>');	
  //localStorage.clear();
  var jio = jIO.newJio({
      "type": "local",
      "username": "Marco",
                ...
                jio.allDocs({
                  ...
                  function (err, response) {
                    str = "<form><div data-role='fieldcontain'" +
                      ...
                      "<div data-role='fieldcontain' data-mini='true'><label for='begindate' class='datelabel'>Begin date:" +
                      ...
                      "' type='text'/></div>" +
                      "<div data-role='fieldcontain' data-mini='true'><label for='enddate' class='datelabel'>End date:" +
